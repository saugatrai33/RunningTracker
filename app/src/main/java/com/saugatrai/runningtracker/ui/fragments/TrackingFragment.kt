...
import com.saugatrai.runningtracker.db.Run
...
import com.saugatrai.runningtracker.services.Polyline
import com.saugatrai.runningtracker.services.TrackingService
...
const val CANCEL_DIALOG_RUN = "CANCELDIALOG"
...
class TrackingFragment : Fragment(R.layout.fragment_tracking) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null) {
            val cancelTrackingDialog = parentFragmentManager.findFragmentByTag(CANCEL_DIALOG_RUN)
    ...
    private fun showCancelTrackingDialog() {
        ...
        }.show(parentFragmentManager, CANCEL_DIALOG_RUN)
    }
