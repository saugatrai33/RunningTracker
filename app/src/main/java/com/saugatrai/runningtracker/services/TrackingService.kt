...
import com.saugatrai.runningtracker.other.Constants.ACTION_SHOW_TRACKING_FRAGMENT
...
import com.saugatrai.runningtracker.ui.MainActivity
        ...
        intent?.let {
            when (it.action) {
                ACTION_START_OR_RESUME_SERVICE -> {
                    if (isFirstRun) startForegroundService() else Timber.d("Service Resume")
                }
